...
exports.credentialIssuedEmail = credentialIssuedEmail;
exports.credentialRevokedEmail = credentialRevokedEmail;
...
function credentialIssuedEmail(params) {
    const content = `
...
function credentialRevokedEmail(params) {
    const content = `
...
function onboardingEmail(params) {
    const content = `
